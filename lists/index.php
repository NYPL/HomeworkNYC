...
<head>
	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).ready(function() {
			...
			$('#myLists').load('_ajax_results.php?nypl_user_id='+nypl_user_id);
...
//					$('#lists').load('_ajax_results.php?noLogin=true&list=<?=$nypl_user_id?>-'+escape($(this).html()), function() {$('#lists').hide().slideDown()});
					$('#lists').load('_ajax_results.php?noLogin=true&nypl_user_id='+nypl_user_id+'&list='+nypl_user_id+'-'+escape($(this).html()), function() {$('#lists').hide().slideDown()});
				}
			})
